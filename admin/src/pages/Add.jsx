  ...
  return (
    <form className='flex flex-col w-full items-start gap-3' onSubmit={onSubmitHandler}>
      ...
      <div className="w-full">
        ...
        <input onChange={(e) => setDescription(e.target.value)} value={description} className="w-full max-w-125 px-3 py-2" type="text" placeholder='Write Content here' required />
      </div>
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} className="w-full px-3 py-2 sm:w-24" type="number" placeholder='22' required />
        </div>
